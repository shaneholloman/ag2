...
- Different [conversation patterns](/docs/user-guide/advanced-concepts/pattern-cookbook/overview/) like [sequential chats](/docs/user-guide/advanced-concepts/orchestration/sequential-chat), [group chat](/docs/user-guide/advanced-concepts/orchestration/group-chat), [constrained group chat](/docs/user-guide/advanced-concepts/orchestration/group-chat), [customized group chat](/docs/user-guide/advanced-concepts/groupchat/custom-group-chat), [nested chat](/docs/user-guide/advanced-concepts/orchestration/nested-chat) and recursive composition of them.
- Different prompting and reasoning techniques such as [reflection](/docs/use-cases/notebooks/notebooks/agentchat_lats_search#reflection).
- [Tool use](/docs/user-guide/advanced-concepts/tools/) and [code execution](/docs/user-guide/advanced-concepts/code-execution), as well as their [combination](/docs/user-guide/advanced-concepts/code-execution).
