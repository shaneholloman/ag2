...
For lightweight LLM-driven sub-agent delegation see [Subagents](/docs/beta/subagents) — that's a different feature that wraps an Agent in a `#!python run_subtask` tool.
