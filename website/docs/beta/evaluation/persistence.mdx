...
- **[Runs](/docs/beta/evaluation/runs/)** — producing the runs you persist here.
- **[Variants](/docs/beta/evaluation/variants/)** — compare several builds in a single run instead of across iterations.
