...
- [Hub & Identity](/docs/beta/network/hub_and_identity) — `AuthRegistry`, `ApiKeyAuth`, governance rules.
- [Agent Clients](/docs/beta/network/agent_clients) — custom envelope handlers, replacing the default handler.
- [Governance, Audit & Observability](/docs/beta/network/expectations_and_audit) — per-channel expectations and the hub audit log.
