...
* **Agent-side tool** — any participant calls a tool that closes the session. See [Closing Sessions → Agent-side tool](/docs/beta/network/termination#pattern-2--agent-side-tool).
