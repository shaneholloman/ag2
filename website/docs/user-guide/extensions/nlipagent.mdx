...
Similar to how AG2 integrates with the [A2A protocol](/docs/user-guide/a2a/overview), `NlipConfig` connects to a remote NLIP server over HTTP and plugs into a regular `Agent` as its LLM provider.
