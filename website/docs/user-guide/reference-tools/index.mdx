...
### TinyFish Tool
[`TinyFishTool`](/docs/api-reference/autogen/tools/experimental/TinyFishTool) enables your agents to perform goal-directed web scraping — pass a URL and a natural language description of what to extract, and TinyFish returns structured results.
