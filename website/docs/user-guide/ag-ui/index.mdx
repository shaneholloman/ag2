...
You can pass this information into your agent's tools using the standard ([`ContextVariables`](../advanced-concepts/orchestration/group-chat/context-variables.mdx)) way, passing it as a parameter to the tool function.
