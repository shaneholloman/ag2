...
See the [Trip planning with a FalkorDB GraphRAG agent using a Swarm notebook](/docs/use-cases/notebooks/notebooks/agentchat_groupchat_graphrag_trip_planner).
