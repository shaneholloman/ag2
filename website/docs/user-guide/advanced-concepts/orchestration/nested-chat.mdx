...
For further information on setting up a nested chat, see the `register_nested_chats` API reference and this [notebook](/docs/use-cases/notebooks/notebooks/agentchat_nested_chats_chess).
