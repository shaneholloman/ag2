...
Before running this code, make sure to set your `OPENAI_API_KEY` as an environment variable. This example uses `gpt-5-nano`, but you can replace it with any other [model](/docs/user-guide/models/amazon-bedrock) supported by AG2.
