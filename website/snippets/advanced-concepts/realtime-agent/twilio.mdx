...
You can explore and run the complete implementation of the `**`RealtimeAgent`**` demonstrated here by visiting [this notebook](/docs/use-cases/notebooks/notebooks/agentchat_realtime_swarm).
