...
"""Tests for the threshold combinator (``autogen.beta.eval.scorers.threshold``)."""

import pytest
from dirty_equals import IsPartialDict

from autogen.beta.eval import InMemoryTraceSource, Suite, TraceRef, evaluate_traces, scorer
